...
<nav id="botonera">
        ...
        <menu><a href="Puesto de Control.jsp">Mi Perfil</a></menu>
...
<form name="datos"  method="post" action="Perfil.jsp?env=1">
 ...
 <input placeholder="<%out.print(usuario.getNombre());%>"type="text" name="nombre" ></input><br><br>
 <label for="ap1">Apellido 1:</label> 
 <input placeholder="<%out.print(usuario.getApellido1());%>"type="text" name="ap1" ></input><br><br>
 <label for="ap2">Apellido 2:</label> 
 <input placeholder="<%out.print(usuario.getApellido1());%>"type="text" name="ap2"></input><br><br>
   <label for="email">Email:</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 <input placeholder="<%out.print(usuario.getCorreo());%>"type="text" name="email"></input><br><br>
   <label for="telefono">Teléfono:</label> &nbsp;
 <input placeholder="<%out.print(usuario.getCorreo());%>"type="text" name="telefono"></input><br><br>
...
<button type='submit' class='login-button'>Guardar cambios</button>
 ...
 <form name="envio"method="post" enctype="multipart/form-data" action="Perfil.jsp?env=2"><br>
